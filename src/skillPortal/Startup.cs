...
using SkillPortal.Authorization;
...
namespace SkillPortal
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("skillPortal"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "SkillPortal API", Version = "v1" });
            ...
            services.AddScoped<ISocialUserManager, SocialUserManager>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "SkillPortal API V1");
            });
